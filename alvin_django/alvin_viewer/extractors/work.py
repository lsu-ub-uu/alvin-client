...
from .common import _get_label, _get_value, _norm_rt, _xp, agents, compact, dates, decorated_text, decorated_list_item, electronic_locators, first, origin_place, titles
...
def extract(root: etree._Element) -> dict:
    data = compact({
        ...
        "origin_places": origin_place(root, _xp(rt, "originPlace")),
