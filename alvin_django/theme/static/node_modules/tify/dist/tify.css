...
.tify-toc-toggle:not(:disabled),
.tify-scan-reset:not(:disabled),
.tify-scan-page-button:not(:disabled),
.tify-scan-button:not(:disabled),
.tify-page-select-button:not(:disabled),
.tify-header-button:not(:disabled),
.tify-collection-link:not(:disabled),
.tify-toc-toggle-all:not(:disabled),
.tify-info-toggle:not(:disabled),
.tify-info-button:not(:disabled),
.tify-export-toggle:not(:disabled),
.tify-collection-reset:not(:disabled) {
    cursor: pointer
}

.tify-toc-toggle:not(:disabled):hover,
.tify-scan-reset:not(:disabled):hover,
.tify-scan-page-button:not(:disabled):hover,
.tify-scan-button:not(:disabled):hover,
.tify-page-select-button:not(:disabled):hover,
.tify-header-button:not(:disabled):hover,
.tify-collection-link:not(:disabled):hover,
.tify-toc-toggle-all:not(:disabled):hover,
.tify-info-toggle:not(:disabled):hover,
.tify-info-button:not(:disabled):hover,
.tify-export-toggle:not(:disabled):hover,
.tify-collection-reset:not(:disabled):hover,
.tify-toc-toggle:not(:disabled):focus,
.tify-scan-reset:not(:disabled):focus,
.tify-scan-page-button:not(:disabled):focus,
.tify-scan-button:not(:disabled):focus,
.tify-page-select-button:not(:disabled):focus,
.tify-header-button:not(:disabled):focus,
.tify-collection-link:not(:disabled):focus,
.tify-toc-toggle-all:not(:disabled):focus,
.tify-info-toggle:not(:disabled):focus,
.tify-info-button:not(:disabled):focus,
.tify-export-toggle:not(:disabled):focus,
.tify-collection-reset:not(:disabled):focus,
.tify-toc-toggle:not(:disabled):active,
.tify-scan-reset:not(:disabled):active,
.tify-scan-page-button:not(:disabled):active,
.tify-scan-button:not(:disabled):active,
.tify-page-select-button:not(:disabled):active,
.tify-header-button:not(:disabled):active,
.tify-collection-link:not(:disabled):active,
.tify-toc-toggle-all:not(:disabled):active,
.tify-info-toggle:not(:disabled):active,
.tify-info-button:not(:disabled):active,
.tify-export-toggle:not(:disabled):active,
.tify-collection-reset:not(:disabled):active {
    background: #7fbfa7
}
...
.tify-toc-toggle:not(:disabled):focus-visible,
.tify-scan-reset:not(:disabled):focus-visible,
.tify-scan-page-button:not(:disabled):focus-visible,
.tify-scan-button:not(:disabled):focus-visible,
.tify-page-select-button:not(:disabled):focus-visible,
.tify-header-button:not(:disabled):focus-visible,
.tify-collection-link:not(:disabled):focus-visible,
.tify-toc-toggle-all:not(:disabled):focus-visible,
.tify-info-toggle:not(:disabled):focus-visible,
.tify-info-button:not(:disabled):focus-visible,
.tify-export-toggle:not(:disabled):focus-visible,
.tify-collection-reset:not(:disabled):focus-visible {
    outline: 2px solid var(--tify-base-color-light, #7fbfa7);
    z-index: 1
}

[disabled].tify-toc-toggle,
[disabled].tify-scan-reset,
[disabled].tify-scan-page-button,
[disabled].tify-scan-button,
[disabled].tify-page-select-button,
[disabled].tify-header-button,
[disabled].tify-collection-link,
[disabled].tify-toc-toggle-all,
[disabled].tify-info-toggle,
[disabled].tify-info-button,
[disabled].tify-export-toggle,
[disabled].tify-collection-reset {
    opacity: .3
}
...
.tify-collection-item.-current .tify-collection-link {
    background: var(--tify-link-color, var(--tify-base-color, #7fbfa7)) linear-gradient(to bottom, #fff3, #fff0);
    color: #fff;
    z-index: 1
}

.tify-info-button.-active:not(:disabled):hover,
.tify-header-button.-active:not(:disabled):hover,
.tify-collection-item.-current .tify-collection-link:not(:disabled):hover,
.tify-info-button.-active:not(:disabled):focus,
.tify-header-button.-active:not(:disabled):focus,
.tify-collection-item.-current .tify-collection-link:not(:disabled):focus,
.tify-info-button.-active:not(:disabled):active,
.tify-header-button.-active:not(:disabled):active,
.tify-collection-item.-current .tify-collection-link:not(:disabled):active {
    background: var(--tify-link-color, var(--tify-base-color, #7fbfa7)) linear-gradient(to bottom, #fff1, #0002);
    color: #fff
}
...
.tify.-medium .tify-toc,
.tify.-medium .tify-thumbnails,
.tify.-medium .tify-scan,
.tify.-medium .tify-info,
.tify.-medium .tify-help,
.tify.-medium .tify-fulltext,
.tify.-medium .tify-export,
.tify.-medium .tify-collection {
    border: 0;
    bottom: 0;
    min-width: 0;
    position: absolute;
...
.tify-toc:first-child,
.tify-thumbnails:first-child,
.tify-scan:first-child,
.tify-info:first-child,
.tify-help:first-child,
.tify-fulltext:first-child,
.tify-export:first-child,
.tify-collection:first-child {
    border: 0
}

.-active.tify-toc,
.-active.tify-thumbnails,
.-active.tify-scan,
.-active.tify-info,
.-active.tify-help,
.-active.tify-fulltext,
.-active.tify-export,
.-active.tify-collection {
    display: block
}

.-always-active.tify-toc,
.-always-active.tify-thumbnails,
.-always-active.tify-scan,
.-always-active.tify-info,
.-always-active.tify-help,
.-always-active.tify-fulltext,
.-always-active.tify-export,
.-always-active.tify-collection {
    display: block !important
}

.tify {
    background: var(--tify-body-bg, black url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAAECAYAAACp8Z5+AAAAEElEQVQImWNgwAGkcElgAgAEogAbFZcwKQAAAABJRU5ErkJggg==));
...
.tify a {
    color: var(--tify-link-color, var(--tify-base-color, #BF7F7F));
...
.tify a:focus,
.tify a:active {
    color: var(--tify-link-hover-color, var(--tify-link-color, var(--tify-base-color, #7fbfa7)))
}
...
.tify-error-close:hover,
.tify-error-close:focus,
.tify-error-close:active {
    background: #0000001a
}
...
.tify-fulltext-item {
    margin: 0 calc(var(--tify-grid-base, 24px) * -.75);
    padding: 0 calc(var(--tify-grid-base, 24px) * .5)
}

.tify-fulltext-item.-current {
    box-shadow: calc(var(--tify-grid-base, 24px) * -.25) 0 var(--tify-base-color-light, #73abda);
    color: var(--tify-link-color, var(--tify-base-color, #06b))
}

.tify-fulltext-toggle {
    border-radius: var(--tify-border-radius, 2px);
    cursor: pointer;
    display: block;
    padding: calc(var(--tify-grid-base, 24px) * .25);
...
.tify-fulltext-toggle:hover,
.tify-fulltext-toggle:focus,
.tify-fulltext-toggle:active {
    background: var(--tify-base-color-lighter, #e6f0f8);
    color: var(--tify-link-color, var(--tify-base-color, #06b))
}

.tify-fulltext-toggle:hover>span,
.tify-fulltext-toggle:focus>span,
.tify-fulltext-toggle:active>span {
    background: var(--tify-base-color-lighter, #e6f0f8)
}

.tify-fulltext-toggle p {
    margin: 0
}
...
.tify-fulltext-page {
    margin: 0 calc(var(--tify-grid-base, 24px) * .25) var(--tify-grid-base, 24px) calc(var(--tify-grid-base, 24px) * .5)
}
...
.tify-header-button-group.-view:nth-child(n+2),
.tify-header-column.-pagination~.tify-header-column .tify-header-button-group.-view {
    border-left: 1px solid black
}

.tify.-large .tify-header-button-group.-view:nth-child(n+2),
.tify.-large .tify-header-column.-pagination~.tify-header-column .tify-header-button-group.-view {
    border-left: 0
}
...
.tify-page-select+.tify-header-button:not(:disabled):hover,
.tify-page-select+.tify-header-button:not(:disabled):focus,
...
.tify-page-select-dropdown:before {
    ...
    z-index: -1;
    bottom: auto;
    bottom: calc(calc(var(--tify-grid-base, 24px) * -.25) - var(--tify-border-radius, 2px));
    left: calc(var(--tify-grid-base, 24px) * .5);
    right: auto
}
...
.tify-page-select-list>li>a:focus,
.tify-page-select-list>li>a:active {
    background: #0000001a
}
...
.tify-page-select-list a:hover,
.tify-page-select-list a:focus,
.tify-page-select-list a:active {
    color: inherit
}
...
.tify-scan-overlay {
    border-radius: var(--tify-border-radius, 2px);
    box-shadow: 0 0 0 1px var(--tify-link-color, var(--tify-base-color, #06b)), 0 0 0 1.5px #fff6;
    cursor: pointer
}

.tify-scan-overlay:hover,
.tify-scan-overlay:focus,
.tify-scan-overlay:active {
...
.tify-scan-overlay.-current {
    background: none;
    -webkit-backdrop-filter: invert(100%) brightness(120%);
...
.tify-thumbnails-item:hover,
.tify-thumbnails-item:focus,
.tify-thumbnails-item:active {
    background: currentColor;
...
.tify-toc-link:hover,
.tify-toc-link:focus,
.tify-toc-link:active {
    background: var(--tify-base-color-lighter, #e6f0f8)
}

.tify-toc-link:hover>span,
.tify-toc-link:focus>span,
.tify-toc-link:active>span {
    background: var(--tify-base-color-lighter, #e6f0f8)
}
