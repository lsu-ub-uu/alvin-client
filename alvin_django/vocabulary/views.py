...
def userguide(request):
  template = loader.get_template('vocabulary/userguide.html')
  return HttpResponse(template.render())

def api(request):
  template = loader.get_template('vocabulary/api.html')
  return HttpResponse(template.render())

def oai_pmh(request):
  template = loader.get_template('vocabulary/oai-pmh.html')
  return HttpResponse(template.render())

def iiif(request):
  template = loader.get_template('vocabulary/iiif.html')
  return HttpResponse(template.render())

def vocabulary(request):
  template = loader.get_template('vocabulary/vocabulary.html')
  return HttpResponse(template.render())

def cataloguing(request):
  template = loader.get_template('vocabulary/cataloguing.html')
  return HttpResponse(template.render())

def place(request):
  template = loader.get_template('vocabulary/place.html')
  return HttpResponse(template.render())

def person(request):
  template = loader.get_template('vocabulary/person.html')
  return HttpResponse(template.render())

def organisation(request):
  template = loader.get_template('vocabulary/organisation.html')
  return HttpResponse(template.render())
