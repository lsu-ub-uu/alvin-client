...
def extract(root: etree._Element) -> AlvinRecord:
    ...
    return AlvinRecord(
        ...
        transcription = decorated_text(root, _xp(rt, "transcription")),
        table_of_contents = decorated_text(root, _xp(rt, "tableOfContents")),
